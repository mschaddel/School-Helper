...
public class SQLHandler extends SQLiteOpenHelper{
    ...
    private static final String CREATE_PROFILE_TABLE = "CREATE TABLE " + TABLE_PROFILE + "("
            + KEY_PROFILEID + " INTEGER PRIMARY KEY," + KEY_NAME + " STRING PRIMARY KEY," + KEY_EMAIL + " TEXT,"
    ...
    private static final String CREATE_CLASS_TABLE = "CREATE TABLE " + TABLE_CLASS + "("
            + KEY_CLASSID + " INTEGER PRIMARY KEY," + KEY_CLASS_NAME + " STRING PRIMARY KEY," + KEY_PROFESSOR + " TEXT,"
            + KEY_CLASS_LOCATION + " TEXT" + KEY_CLASS_TIME +" TIME" + KEY_CLASS_DOCUMENTS + " TEXT" + ")";
    
    private static final String CREATE_EVENT_TABLE = "CREATE TABLE " + TABLE_EVENT + "("
            + KEY_EVENTID + " INTEGER PRIMARY KEY," + KEY_EVENT_NAME + " STRING PRIMARY KEY," + KEY_EVENT_DATE + " DATE," 
    		+ KEY_EVENT_LOCATION + " TEXT" + KEY_EVENT_TIME + " INTEGER" + KEY_DESCRIPTION 
            +" TEXT" + KEY_EVENT_DOCUMENTS + " TEXT" + ")";
	...
	public List<SQLEvent> getallEventsClass(String class_name){
		...
		String Query = "SELECT * FROM " + TABLE_EVENT + " WHERE " + KEY_CLASS_NAME + " = '" + class_name + "'";
	...
	public List<SQLEvent> getallEventsDate(String date){
		...
		String Query = "SELECT * FROM " + TABLE_EVENT + " WHERE " + KEY_EVENT_DATE + " = '" + date + "'";
	...
	public List<SQLClass> getClassesInfo(String class_name){
		...
		String Query = "SELECT * FROM " + TABLE_CLASS + " WHERE " + KEY_CLASS_NAME + " = '" + class_name + "'";
