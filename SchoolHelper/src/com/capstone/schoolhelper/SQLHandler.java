...
public class SQLHandler extends SQLiteOpenHelper {
	...
	private static final String CREATE_PROFILE_TABLE = "CREATE TABLE "
			+ TABLE_PROFILE + "(" + KEY_NAME + " STRING PRIMARY KEY,"
			+ KEY_EMAIL + " TEXT," + KEY_SCHOOL + " TEXT" + KEY_NOTIFICATIONS
			+ " TEXT" + KEY_MODE + " INTEGER" + ")";

	private static final String CREATE_CLASS_TABLE = "CREATE TABLE "
			+ TABLE_CLASS + "(" + KEY_CLASS_NAME + " STRING PRIMARY KEY,"
			+ KEY_PROFESSOR + " TEXT," + KEY_LOCATION + " TEXT"
			+ KEY_CLASS_TIME + " TIME" + KEY_CLASS_DOCUMENTS + " TEXT" + ")";

	private static final String CREATE_EVENT_TABLE = "CREATE TABLE "
			+ TABLE_EVENT + "(" + KEY_EVENT_NAME + " STRING PRIMARY KEY,"
			+ KEY_EVENT_DATE + " DATE," + KEY_EVENT_TIME + " INTEGER"
			+ KEY_DESCRIPTION + " TEXT" + KEY_EVENT_DOCUMENTS + " TEXT" + ")";
